...
class DeepCoNN(object):
    def __init__(
        ...
        with tf.name_scope("user_embedding"):
            ...
            self.embedded_users = tf.expand_dims(self.embedded_user, -1)  # B x user_len x emb_size x 1
        ...
        for i, filter_size in enumerate(filter_sizes):
            with tf.name_scope("user_conv-maxpool-%s" % filter_size):
                # Convolution Layer
                filter_shape = [filter_size, embedding_size, 1, num_filters]  # k x emb_size x 1 x num_filters
